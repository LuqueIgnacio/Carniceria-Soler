function Legal(){
    return(
        <main class="contenedor contenedor-legales">
            <p class="legales-titulo">INFORMACIÓN RELEVANTE</p>
        ...
        Los precios de los productos ofrecidos en esta Tienda Online es válido solamente en las compras realizadas en este sitio web.</p>
            ...
            <p class="legales-titulo">LICENCIA</p>
            <p>Carnicería y Kiosco Soler  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>

            <p class="legales-titulo">USO NO AUTORIZADO</p>
            ...
            <p class="legales-titulo">PROPIEDAD</p>
            ...
            <p class="legales-titulo">POLÍTICA DE REEMBOLSO Y GARANTÍA</p>
        ...
        – En condiciones de operación eléctricas acorde con las especificaciones y tolerancias indicadas.</p>
            ...
            <p class="legales-titulo">COMPROBACIÓN ANTIFRAUDE</p>
            ...
            <p class="legales-titulo">PRIVACIDAD</p>
            <p>Este CarniceriaSoler.com garantiza que la valencia cf noticias información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.

        La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.

        Carnicería y Kiosco Soler reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
